...
public final class PopupBinding implements ViewBinding {
  ...
  private PopupBinding(@NonNull ConstraintLayout rootView, @NonNull EditText upperLimitEditText) {
  ...
  public static PopupBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new PopupBinding((ConstraintLayout) rootView, upperLimitEditText);
    }
